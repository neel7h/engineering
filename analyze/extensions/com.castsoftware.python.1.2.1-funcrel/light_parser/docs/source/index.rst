...
This library can be used to build **non validating** language parsers.
...
They have a recursive structure. The beginning and end of a block are given by a pattern.
