create or replace function SET_SQLScript_1101000(I_SET_ID int)
Return INT
Is
	ERRORCODE	INT := 0;
begin
...
End  SET_SQLScript_1101000; 
/

create or replace function SET_SQLScript_1101001(I_SET_ID int)
Return INT
Is
	ERRORCODE	INT := 0;
begin
...
End  SET_SQLScript_1101001; 
/
create or replace function SET_SQLScript_1101013(I_SET_ID int)
Return INT
Is
	ERRORCODE	INT := 0;
begin
...
End  SET_SQLScript_1101013; 
/
create or replace function SET_SQLScript_1101014(I_SET_ID int)
Return INT
Is
	ERRORCODE	INT := 0;
begin
...
End  SET_SQLScript_1101014; 
/
create or replace function SET_SQLScript_1101002(I_SET_ID int)
Return INT
Is
	ERRORCODE	INT := 0;
begin
...
End  SET_SQLScript_1101002; 
/
create or replace function SET_SQLScript_1101003(I_SET_ID int)
Return INT
Is
	ERRORCODE	INT := 0;
begin
...
End  SET_SQLScript_1101003; 
/
create or replace function SET_SQLScript_1101036(I_SET_ID int)
Return INT
Is
	ERRORCODE	INT := 0;
begin
...
End  SET_SQLScript_1101036; 
/
create or replace function SET_SQLScript_1101044(I_SET_ID int)
Return INT
Is
	ERRORCODE	INT := 0;
begin
...
End  SET_SQLScript_1101044; 
/
create or replace function SET_SQLScript_1101046(I_SET_ID int)
Return INT
Is
	ERRORCODE	INT := 0;
begin
...
End  SET_SQLScript_1101046; 
/
create or replace function SET_SQLScript_1101048(I_SET_ID int)
Return INT
Is
	ERRORCODE	INT := 0;
begin
...
End  SET_SQLScript_1101048; 
/
create or replace function SET_SQLScript_1101050(I_SET_ID int)
Return INT
Is
	ERRORCODE	INT := 0;
begin
