create or replace function DSS_DIAG_SCOPE_1101044 (
	I_SNAPSHOT_ID       int,
...
begin
	...
	select 
		T1.OBJECT_ID, I_METRIC_ID, I_METRIC_CHILD_ID, SC.MODULE_ID, I_SNAPSHOT_ID, 0, Null, 0, 0
	from 
		DSSAPP_MODULES SC 
	...
	where 
		...
		And T1.OBJECT_TYPE	= 1101013
		And TN.OBJECT_NAME similar to '%[^a-zA-Z0-9_]%';
